...
<BODY onload = "javascript:showlayer('alert')" onResize="javascript:centrelayer('alert')">
  <div id="alert" class="alert">
	...
	<p>We are trying a new editor which should work better and allow better formatting options.</p>
	<p>Please let <a href="mailto:greg@datainn.co.nz">Greg</a> know if you have any problems.</p>
