...
<body<%=onload%>>
    <h1>THOUGHTS MAINTENANCE</h1>
    <form name="maint" method="post" action="thoughts_process.asp" OnSubmit="return checkform();">
	<input name="id" type="hidden" id="id" value="<%=id%>">
      <table width="500" border="1" cellspacing="0" cellpadding="1">
        ...
        <tr>
          ...
          <td><input name="author" type="text" id="author" value="<%=author%>" style="width:100%"></td>
        </tr>
        <tr>
          <td><div align="right">Description</div></td>
          <td><input name="description" type="text" id="description" value="<%=startdate%>"></td>
        </tr>
		<tr>
