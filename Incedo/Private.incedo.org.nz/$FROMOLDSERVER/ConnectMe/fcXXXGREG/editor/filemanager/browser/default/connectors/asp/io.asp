...
'DATAINN START
	...
	If ConfigDirectories.Item( resourceType ) = "" Then
		GetUrlFromPath = RemoveFromEnd( sUserFilesPath, "/" ) & folderPath
	Else
		GetUrlFromPath = sUserFilesPath & ConfigDirectories.Item( resourceType ) & folderPath
	End If
...
Function ServerMapFolder( resourceType, folderPath )
	...
	'DATAINN sResourceTypePath = sUserFilesDirectory & resourceType & "\"
	sResourceTypePath = sUserFilesDirectory & ConfigDirectories.Item( resourceType ) & "\" 'DATAINN
