...
namespace General.Functions
{
    public class Functions
    {
        ...
        public static dps_Result PXPost(string cardholder, string cardnumber, string amount, string expirydate, string narrative)
        {
            dps_Result gwResult = new dps_Result();
        ...
        public static string[] populatelist(string grouptype, string name)
        {
            string str = "";
            ...
            //    con.Dispose();
            //}
            string[] myarray = str.Split(new string[] { "|" }, StringSplitOptions.None);
            return myarray;
        }
