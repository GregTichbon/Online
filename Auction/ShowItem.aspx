        ...
        $(document).ready(function () {
            ...
            function placebid() {
                if (Number($("#bid").val()) <= Number($("#hf_highestbid").val())) {
                    ...
                    $("#confirmation-message").html("<br />Please confirm that you would like to make a bid of $" + $("#bid").val() + ".00 on the following item:<br /><br /><b>" + $('#hf_title') + "</b>");
                    $(function () {
                        mywidth = $(window).width() * .95;
                        if (mywidth > 500) {
                            mywidth = 500;
...
<body>
    <form id="form1" runat="server">
        <div id="dialog-confirm" title="Bid Confirmation">
            <p><span style="float: left; margin: 0 7px 20px 0;"></span><span id="confirmation-message"></span></p>
        </div>
        <div id="dialog-response" title="Bid Response">
            <p><span style="float: left; margin: 0 7px 20px 0;"></span><span id="response-message"></span></p>
        </div>
        <div id="dialog-help" title="HELP!" style="display: none">
            <p>
                <span style="float: left; margin: 0 7px 20px 0;"></span><span id="help-message">
                    <br />
        ...
        <table class="table">
            ...
            <tr>
                <td style="vertical-align: middle;">
                    <div align="right" id="usernamelabel"><%=usernamelabel%></div>
                </td>
                <td style="vertical-align: middle;"><span id="username"><%=usernamedisplay%></span></td>
            </tr>
            <tr style="display: <%=displayregister%>" id="registerhere">
                <td style="vertical-align: middle;">
                    <div align="right">Don't have a pass code?</div>
                </td>
                <td style="vertical-align: middle;">
            ...
            <tr>
                <td>
                    <div align="right">Highest bid:</div>
                </td>
                <td><span id="highestbid"><%=highestbid%></span></td>
            </tr>
            <tr>
                <td>
                    <div align="right">Highest bidder:</div>
                </td>
            ...
            <tr style="display: none">
                <td>
                    <div align="right">Next minimum bid:</div>
                </td>
                <td><span id="nextminimum"><%=nextminimum%></span></td>
            </tr>
            <tr>
                <td>
                    <div align="right">Your bid </div>
                </td>
                <td nowrap>$
            ...
            <tr>
                <td colspan="2">
                    <input style="width: 100%; color: black" type="button" name="submit" id="submit" value="Place Your Bid" /></td>
            </tr>
