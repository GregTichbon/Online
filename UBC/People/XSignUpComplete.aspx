<%@ Page Title="" Language="C#" MasterPageFile="~/UBC.Master" AutoEventWireup="true" CodeBehind="SignUpComplete.aspx.cs" Inherits="UBC.People.SignUpComplete" %>
    ...
    <div class="container" style="background-color:#B1C9E6" >
        ...
        <div class="panel panel-danger">
            ...
            <div class="style1">
                ...
                <br />
                Get more information from the <a href="https://ubc.org.nz/people/SchoolLearntoRowAug2019.pdf" target="_blank">brochure</a>
                <br />
                <br />
