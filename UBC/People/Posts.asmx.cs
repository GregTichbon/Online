    ...
    public class Posts : System.Web.Services.WebService
    {
        ...
        public standardResponseID send_email_text(NameValue[] formVars)    //you can't pass any querystring params
        {
            ...
            if (type == "email")
            {
                ...
                emailhtml = emailhtml.Replace("||redirect||", "https://ubc.org.nz/Folder" + id + "/redirect.aspx?url=");
            ...
            if (type == "text")
            {
                ...
                text = text.Replace("||redirect||", "https://ubc.org.nz/Folder" + id + "/redirect.aspx?url=");
