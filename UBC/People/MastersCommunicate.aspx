        ...
        $(document).ready(function () {
            $('#btn_submit').click(function (e) {
                ...
                $("#tbl_people > tbody > tr > td > input:checked").each(function () {
                    id = $(this).attr("id");
                    recipient = $(this).val();
                    if (id.substring(0, 9) == 'cb_email_') { //shouldn't be the person id but the email id
                        type = 'email';
                        id = id.substring(9);   //should be a data attribute
...
&lt;/p&gt;</textarea><br />
        ...
        <table id="tbl_people" class="table table-hover"><thead>
           <tr><th colspan="2">Person</th><th><input id="cb_textall" type="checkbox" /> Send Text</th><th><input id="cb_emailall" type="checkbox" /> Send Email</th></tr></thead><tbody>
            <%=html %>
            </tbody>
        </table>
