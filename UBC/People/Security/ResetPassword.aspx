<%@ Page Title="" Language="C#" MasterPageFile="~/UBC.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="UBC.People.Security.ResetPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <input id="hf_entity_ctr" name="hf_entity_ctr" type="hidden" value="<%:entity_ctr %>" />
