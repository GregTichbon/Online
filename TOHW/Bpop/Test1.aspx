<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test1.aspx.cs" Inherits="TOHW.Bpop.Test1" %>
    ...
    <div id="page">
        ...
        $(<span class="code-string">'element_to_pop_up'</span>).bPopup({
            ...
            <li>
                ...
                <span class="button small pop2 x-content" data-bpopup='<img src="assets/dinbror.jpg" style="height:131px;width:660px" />'>Pop an image</span>
