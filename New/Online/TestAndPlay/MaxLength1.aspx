...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="<%: ResolveUrl("~/Scripts/MaxLength/jquery.maxlength.css")%>" rel="stylesheet" />


    <script src="<%: ResolveUrl("~/Scripts/MaxLength/jquery.plugin.min.js")%>"></script>
    <script src="<%: ResolveUrl("~/Scripts/MaxLength/jquery.maxlength.min.js")%>"></script>
