...
namespace Online.posts
{
    ...
    public class Posts : System.Web.Services.WebService
    {
        ...
        public string CreditCardProcess(NameValue[] formVars)    //you can't pass any querystring params
        {
            ...
            int hf_Payment_Request_CTR = Convert.ToInt16(formVars.Form("hf_Payment_Request_CTR"));
            string fullamount = "";
            ...
            cmd.Parameters.Add("@Payment_Request_CTR", SqlDbType.Int).Value = hf_Payment_Request_CTR;
