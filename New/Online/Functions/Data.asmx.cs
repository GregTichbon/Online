...
namespace Online.data
{
    ...
    public class Data : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        //[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void RIDCharges(string property_no, int next_year)
        {
        ...
        [WebMethod]
        //[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void RIDHeader(string property_no, int next_year)
        {
        ...
        public void NZPostAddressSearch(string term)
        {
            ...
            //String strConnString = ConfigurationManager.ConnectionStrings["PROnlineConnectionString"].ConnectionString;
            String strConnString = "Data Source=192.168.1.225;Initial Catalog=OnlineApplications;Integrated Security=False;user id=OnlineServices;password=Whanganui101";
        ...
        [WebMethod]
        //[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void entity_emailaddress(string tb_emailaddress)
        {
            ...
            SqlCommand cmd = new SqlCommand("emailaddress_check", con);
            cmd.CommandType = CommandType.StoredProcedure;
