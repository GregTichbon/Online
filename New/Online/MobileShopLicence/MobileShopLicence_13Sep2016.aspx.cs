...
{
    public partial class MobileShopLicence_13Sep2016 : System.Web.UI.Page
    {
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            WDCFunctions.Log(Request.RawUrl, "submit", "");
            ...
            if (!inhibit_upload)
            {
                ...
                othercouncil = WDCFunctions.saveattachments(submissionpath + tb_reference.Text, "", fu_othercouncil, "", Request.RawUrl);
            ...
            //    cmd2.Parameters.Add("@Entity_ctr", SqlDbType.Int).Value = Convert.ToInt32(Session["online_entity_ctr"]);
...
/*This is now a function
            ...
            strConnString = ConfigurationManager.ConnectionStrings["PROnlineConnectionString"].ConnectionString;
...
*/
            ...
            a.entityfields(Entity_CTR, documentvalues);
