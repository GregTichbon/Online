...
namespace Online.Payment
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        public int payment_request_ctr = 0;
        public string paymentrequestreference = "";
        public string emailaddress = "";
        public decimal transactionfee = 0;
        public decimal surcharge = 0;
        public decimal calcamount = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            calcamount = Convert.ToDecimal(dt.Rows[0]["amount"]);
            amount = calcamount.ToString("0.00");

            if (Convert.ToBoolean(dt.Rows[0]["AddFees"]))
            {
                transactionfee = .5M; //to do with function
                surcharge = 1.37M; //to do
            }
            else
            {
                transactionfee = 0M;
