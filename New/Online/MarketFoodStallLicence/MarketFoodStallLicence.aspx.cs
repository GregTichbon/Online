...
namespace Online.MarketFoodStallLicence
{
    public partial class MarketFoodStallLicence : System.Web.UI.Page
    {
        ...
        static string moduleName = "MarketFoodStallLicence";
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (!inhibit_hubble)
            {
                ...
                HF.createSmartListItem("http://" + siteURL, RAM_ID.Replace('/', '-'), 0, RAM_year.ToString(), "Market Food Stall - " + Request.Form["tb_organisationname"]);
            }
            #endregion
