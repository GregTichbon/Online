<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="maint.aspx.cs" Inherits="DataInnovations.UBC.LTR.maint" %>
    ...
    <div class="container" style="background-color: #FCF7EA">
        <form id="form1" runat="server" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="tb_facebook" name="tb_facebook" type="text" class="form-control" value="<%:tb_facebook%>" maxlength="100" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select id="dd_school" name="dd_school" class="form-control" required>
                        <option></option>
                        <%
                            foreach (string option in school)
                            {
                                string selected = "";
                                if (option == dd_school)
                                {
