...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <input id="hf_sitearray" name="hf_sitearray" type="hidden" />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-1">
            <input id="cb_wheredoifit" name="cb_wheredoifit" class="form-control" type="checkbox" value="Yes" />
        </div>
    </div>
    ...
    <div id="div_showform" style="display: <%:none%>">
        ...
        <div class="form-group" id="div_registrationnumbers" style="display: <%: none%>">
            ...
            <div class="col-sm-8">
                <input type="text" id="tb_registrationnumbers" name="tb_registrationnumbers" class="form-control" maxlength="100" required />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select id="dd_businesstype" name="dd_businesstype" class="form-control" required>
                    <option></option>
                    <%= Online.WDCFunctions.WDCFunctions.populateselect(businesstypes, "","") %>
                </select>
            </div>
        </div>
        ...
        <div id="div_businessnumber" class="form-group" style="display:<%:none%>">
            ...
            <div class="col-sm-8">
                <input type="text" id="tb_businessnumber" name="tb_businessnumber" class="form-control" maxlength="100" required />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" id="tb_businessname" name="tb_businessname" class="form-control" maxlength="100" required />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select id="dd_verificationagency" name="dd_verificationagency" class="form-control" required>
                    <option></option>
                    <%= Online.WDCFunctions.WDCFunctions.populateselect(verificationagencies, "","") %>
                </select>
            </div>
        </div>
        ...
        <!-- Postal Address -->
        <div class="form-group">
            <label class="control-label col-sm-4" for="tb_postaladdress">
                Postal address<br />
        ...
        <div class="form-group">
            <label class="control-label col-sm-4" for="cb_withholdpostal">Withhold the postal address from the public? </label>
            <div class="col-sm-1">
                <input id="cb_withholdpostal" name="cb_withholdpostal" class="form-control" type="checkbox" value="Withhold postal address" />
            </div>
        </div>
...
<div style="display: <%:none%>">          <!-- REPEATER SECTION -->
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse_site_" class="panel-collapse collapse repeatupdateid">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_dd_registrationtype_">Registration type<img src="../Images/questionsmall.png" title="As per 'Where do I fit?'" /></label>
                                <div class="col-sm-8">
                                    <select id="repeat_site_dd_registrationtype_"  class="form-control" required>
                                        <option></option>
                            ...
                            <!-- Trading Name-->
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_tradingname_">Trading name</label>
                                <div class="col-sm-8">
                                    <input type="text" id="repeat_site_tb_tradingname_" class="form-control" maxlength="100" required />
                                </div>
                            </div>
                            ...
                            <!-- Physical Address -->
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_physicaladdress_">
        ...
        <img src="../Images/questionsmall.png" title="If you are in 'Address lookup mode' start typing your address (at least 5 characters).  A list of addresses will be given to you as options, please select one.  The more that you type the closer the options provided will be.  If you cannot find your address, change the lookup mode above." />
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <textarea id="repeat_site_tb_physicaladdress_" class="form-control autoaddress" rows="4" required></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_cb_witholdphysical_">Withhold the physical premises address from the public? </label>
                                <div class="col-sm-1">
                                    <input id="repeat_site_cb_witholdphysical_" class="form-control" type="checkbox" value="Withold physical address" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_daytodaymanager_">Day to day manager's name</label>
                                <div class="col-sm-8">
                                    <input id="repeat_site_tb_daytodaymanager_" type="text" class="form-control" required />
                                </div>
                            </div>


                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_daytodaymanagerposition_">Position</label>
                                <div class="col-sm-8">
                                    <input id="repeat_site_tb_daytodaymanagerposition_" type="text" class="form-control" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_daytodaymanageremailaddress_">Email address</label>
                                <div class="col-sm-8">
                                    <input id="repeat_site_tb_daytodaymanageremailaddress_" type="email" class="form-control" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_daytodaymanageremailconfirm_">Please re-type your email address</label>
                                <div class="col-sm-8">
                                    <input id="repeat_site_tb_daytodaymanageremailconfirm_" type="email" class="form-control inhibitcutcopypaste" autocomplete="off" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_daytodaymanagerphonemobile_">Mobile phone</label>
                                <div class="col-sm-8">
                                    <input id="repeat_site_tb_daytodaymanagerphonemobile_" placeholder="eg: 027 123456..." type="text" class="form-control repeatupdatevalidgroup validgroup_daytodaymanagerphone_" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_daytodaymanagerphonehome_">Home phone</label>
                                <div class="col-sm-8">
                                    <input id="repeat_site_tb_daytodaymanagerphonehome_" placeholder="eg: 06 1234567 or 027 123456..." type="text" class="form-control repeatupdatevalidgroup validgroup_daytodaymanagerphone_" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-4 repeatupdatefor" for="repeat_site_tb_daytodaymanagerphonework_">Work phone</label>
                                <div class="col-sm-8">
                                    <input id="repeat_site_tb_daytodaymanagerphonework_" placeholder="eg: 06 1234567 or 027 123456..." type="text" class="form-control repeatupdatevalidgroup validgroup_daytodaymanagerphone_" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4" for="repeat_site_fu_scopeofoperations_">
                                ...
                                <div class="col-sm-4">
                                    <!--<asp:FileUpload ID="repeat_site_fu_scopeofoperations_" runat="server" AllowMultiple="True" />-->
                                        <input id="repeat_site_fu_scopeofoperations_" name="repeat_site_fu_scopeofoperations_" type="file" />

                                    <asp:Label ID="lbl_scopeofoperations" runat="server" Text=""></asp:Label>
                                </div>
                                <div class="col-sm-4">
                                    <a href="https://www.mpi.govt.nz/document-vault/11437" target="_blank">Link to: MPI Scope of operations form</a>
                                </div>

                                <div class="col-sm-12">
                                            <a id="repeat_site_deletesite_" href="javascript:void(0);" class="repeatupdateid deletesite">Delete this site</a>
