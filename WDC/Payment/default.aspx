...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#pagehelp").colorbox({ href: "PaymentHelp.html", iframe: true, height: "600", width: "600", overlayClose: false, escKey: false });
            ...
            $('#a_test').click(function () {
                ...
                $('#dd_expirymonth').val('10');
                $('#dd_expiryyear').val('2020');
                $('#tb_secureid').val('999');
            })
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <input id="hf_detail" name="hf_detail" type="hidden" value="<%: detail %>" />
   ...
   <a id="a_test">Test</a>
    ...
    <table id="testinfo" style="display:none">
        <tr>
            <td>
                ...
                <br />
                <a href="https://www.paymentexpress.com/developer-e-commerce-merchant-hosted-transaction-processing">https://www.paymentexpress.com/developer-e-commerce-merchant-hosted-transaction-processing</a>
                <br />
