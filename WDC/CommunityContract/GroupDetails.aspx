...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        var statementstoupload = 0;
        var budgettoupload = 0;
        ...
        $(document).ready(function () {
            ...
            $("#pagehelp").colorbox({ href: "GroupDetailsHelp.html", iframe: true, height: "600", width: "600", overlayClose: false, escKey: false });
            ...
            $('.fu_statements').change(function (e) {
                statementstoupload = e.target.files.length;
            });

            $('.fu_budget').change(function (e) {
                budgettoupload = e.target.files.length;
            });

            $.validator.addMethod("statementsrequired", function (value, element, params) {
                statements = $('[name=cb_deletestatements]');
                deletedstatements = $(statements).filter(':checked');
                if ($(statements).length - $(deletedstatements).length + statementstoupload == 0) {
                    //alert('You need to uplaod a statements');
                    return (false);
                } else {
                    return (true);
                }
            }, 'Your statements must be supplied');

            $.validator.addMethod("budgetrequired", function (value, element, params) {
                budget = $('[name=cb_deletebudget]');
                deletedbudget = $(budget).filter(':checked');
                if ($(budget).length - $(deletedbudget).length + budgettoupload == 0) {
                    //alert('You need to uplaod a budget');
                    return(false);
                } else {
                    return(true);
                }
            }, 'Your budget must be supplied');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hf_originalreference" runat="server" />
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_grouptype">
            Type of your group
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_charitiesnumber">
            What is your charities number if you have one?
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_gstnumber">
            GST Number
                    <img src="../Images/questionsmall.png" title="If registered." /></label><div class="col-sm-8">
                        <input id="tb_gstnumber" name="tb_gstnumber" type="text" class="form-control" value="<%:tb_gstnumber%>" maxlength="20" />
                    </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_facebook">
            Facebook Page
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_website">
            Website
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="fu_strategicplan">If you have a strategic plan please attach it.</label><div class="col-sm-8">
            <asp:FileUpload ID="fu_strategicplan" runat="server" AllowMultiple="True" /><asp:Label ID="lbl_strategicplan" runat="server" Text=""></asp:Label>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_employedstaff">
            How do you employ staff in your group?
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_employmentcontracts">
            Do you have individual or collective employment contracts?
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_jobdescriptions">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_performancemanagement">
            Is there performance management in place for the management team and staff?
                    <img src="../Images/questionsmall.png" title="Please add comments as required." /></label><div class="col-sm-8">

                        <textarea id="tb_performancemanagement" name="tb_performancemanagement" rows="2" class="form-control" required maxlength="500"><%:tb_performancemanagement%></textarea>
                    </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_paidstaff ">How many paid staff do you have?</label><div class="col-sm-8">
            <input id="tb_paidstaff" name="tb_paidstaff" type="text" class="form-control numeric" value="<%:tb_paidstaff%>" required />
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_paidstaffhours">How many paid hours per week on average are worked?</label><div class="col-sm-8">
            <input id="tb_paidstaffhours" name="tb_paidstaffhours" type="text" class="form-control numeric" value="<%:tb_paidstaffhours%>" required />
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_volunteers">How many volunteers do you have?</label><div class="col-sm-8">
            <input id="tb_volunteers" name="tb_volunteers" type="text" class="form-control numeric" value="<%:tb_volunteers%>" required />
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_volunteerhours">How many volunteer hours per week on average are worked?</label><div class="col-sm-8">
            <input id="tb_volunteerhours" name="tb_volunteerhours" type="text" class="form-control numeric" value="<%:tb_volunteerhours%>" required />
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_accountingprogramme">
            What is the financial accounting system that you use?
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_financialyear">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="fu_statements">
            Please attach your most recent completed financial end-of-year statements.<br />
            If your balance date is 30 June please see the accompanying note. 
                    <img src="../Images/questionsmall.png" title="For 30 June balance dates, a cash flow report and statement of assets and liabilities at balance date must be supplied" /></label><div class="col-sm-8">
                        <asp:FileUpload ID="fu_statements" class="fu_statements" runat="server" AllowMultiple="True" /><asp:Label ID="lbl_statements" runat="server" Text=""></asp:Label>

                    </div>
    </div>

    <div class="form-group">
        <label class="control-label col-sm-4" for="fu_budget">
            Please attach a budget projection for the next financial year. 
        </label>
        <div class="col-sm-8">
            <asp:FileUpload ID="fu_budget" class="fu_budget" runat="server" AllowMultiple="True" /><asp:Label ID="lbl_budget" runat="server" Text=""></asp:Label>
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_payrollsystem">
            What is the payroll system that you use?
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="dd_statutoryobligations">To the best of your knowledge, is your group complying with all statutory obligations?</label>
        <div class="col-sm-8">
            <select id="dd_statutoryobligations" name="dd_statutoryobligations" class="form-control" required>
                <option></option>
                <%
                    foreach (string dd_value in yesno_values)
                    {
                        if (dd_value == dd_statutoryobligations)
                        {
                            selected = " selected";
                        }
                        else
