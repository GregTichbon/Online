...
namespace Online.CommunityContract
{
    public partial class Application : System.Web.UI.Page
    {
        ...
        //public string[] dd_fundingtype_values = new string[2] { "Projects of significance", "Community fund" };
        public string[] dd_fundingtype_values;
        public string viewmode = ""; //"readonly"; //"readonly"; //"";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(submissionperiod == "2018")
            {
                dd_fundingtype_values = new string[2] { "Projects of significance", "Community fund" };
            } else
            {
                dd_fundingtype_values = new string[3] { "1 off", "Seeding", "Matching" };
            }
                    ...
                    try
                    {
                        ...
                        if (dr.HasRows)
                        {
                            ...
                            if (dr["Updated_groupdetails"].ToString() != "Yes")
                            {
                                ...
                                Session["message_head"] = "Your group details must be maintained prior to making a new application.";
                                Session["message_message"] = "When you click on \"Continue\" below you will taken to enter your group details.  Once this has been completed you may enter your application.  PLEASE NOTE: You now need to supply your financial statements for the previous year and budget for the upcoming year.";
                                Session["message_redirect"] = "communitycontract/groupdetails.aspx";
                            ...
                            else
                            {
                                ...
                                string thisperiod = dr["submissionperiod"].ToString();
