<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportEndofPeriod.aspx.cs" Inherits="Online.CommunityContract.ReportEndofPeriod" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#pagehelp").colorbox({ href: "ReportEndofPeriodHelp.html", iframe: true, height: "600", width: "600", overlayClose: false, escKey: false });
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <h1>Community Contracts End of Period Report
    </h1>
