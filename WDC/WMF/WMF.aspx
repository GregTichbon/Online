...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".numeric")({ negative: false, decimalPlaces: 0 });
                ...
                <table class="table" id="table_expenditure">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input id="repeat_expediture_tb_expenditureamount_1" name="repeat_expediture_tb_expenditureamount_1" type="text" class="form-control numeric money expenditureamount" required />
</td>
                            <td>Required</td>
                        </tr>
                ...
                <table class="table" id="table_income">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input id="repeat_income_tb_incomeamount_1" name="repeat_income_tb_incomeamount_1" type="text" class="form-control numeric money incomeamount" required />
</td>
                            <td>Required</td>
                        </tr>
    ...
    <div style="display: <%:none%>">
        ...
        <table>
            <tr id="tr_income_">
                ...
                <td>
                    <input id="repeat_income_tb_incomeamount_" name="repeat_income_tb_incomeamount_" type="text" class="form-control numeric money incomeamount" required /></td>
        ...
        <table>
            <tr id="tr_otherfunding_">
                ...
                <td>
                    ...
                    <input id="repeat_otherfunding_tb_otherfundingamountapplied_" name="repeat_otherfunding_tb_otherfundingamountapplied_" type="text" class="form-control numeric money appliedamount" required />

                </td>
                <td>

                    <input id="repeat_otherfunding_tb_otherfundingamountgranted_" name="repeat_otherfunding_tb_otherfundingamountgranted_" type="text" class="form-control numeric money grantedamount" required />

                </td>
                <td><a href="javascript:void(0)" id="href_deleteotherfunding_" class="deleteotherfunding repeatupdateid">Delete</a></td>
            </tr>
        </table>
        ...
        <table>
            <tr id="tr_similarservice_">
                <td>
                    <input id="repeat_similarservice_tb_service_" name="repeat_similarservice_tb_service_" type="text" class="form-control" required />
                </td>
                <td>
                    <textarea id="repeat_similarservice_tb_differences_" name="repeat_similarservice_tb_differences_" class="form-control autoaddress" rows="3" required></textarea>
                <td><a href="javascript:void(0)" id="href_deletesimilarservice_" class="deletesimilarservice repeatupdateid">Delete</a></td>
            </tr>
        </table>
