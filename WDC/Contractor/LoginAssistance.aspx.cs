...
namespace Online.Contractor
{
    public partial class LoginAssistance : System.Web.UI.Page
    {
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "contractor_loginAssistance";
     ...
     */
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    else
                    {
                        ...
                        if (mode == "Password Reset Request")
                        {
                            ...
                            WDCFunctions.sendemail("Whanganui District Council - Password Reset", emaildocument, emailaddress, "");
                        ...
                        else
                        {
                            ...
                            WDCFunctions.sendemail("Whanganui District Council - xxxxxx Request", emaildocument, emailaddress, "");
                        }
                    }
                }
                else
                {
                    ...
                    Session["message_redirect"] = "contractor/loginassistance.aspx";
                    Response.Redirect("../message.aspx");
                }
            }
            catch (Exception ex)
