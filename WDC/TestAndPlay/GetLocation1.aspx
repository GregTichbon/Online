<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetLocation1.aspx.cs" Inherits="Online.TestAndPlay.GetLocation1" %>
  ...
  <tr>
    ...
    <script>
        $('[title]').tooltipster();    </script>
           ...
           <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCpsWhkuuHlAe6EKhSi5zSlmmIVMN9M8c&libraries=places&callback=initAutocomplete" type="text/javascript"></script>
