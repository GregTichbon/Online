    ...
    <script type="text/javascript">
        ...
        function passlocation(line, location, coords) {
            ...
            if (line == 0) {
                ...
                input = '<input readonly="readonly" style="width:80%" type="text" id="tb_location_' + location_maxline + '" name="tb_location_' + location_maxline + '" class="form_control col-sm-8" value="' + location + '" />';
