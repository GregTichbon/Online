    ...
    <script type="text/javascript">
        ...
        function passlocation(line, location, coords) {
            ...
            if (line == 0) {
                ...
                input = '<input readonly="readonly" style="width:80%" type="text" id="' + location_userepeatname + 'tb_location_' + location_maxline + '" name="' + location_userepeatname + 'tb_location_' + location_maxline + '" class="form_control col-sm-8" value="' + location + '" />';
