...
namespace Online.PolicySubmissions.Parking1117
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        public string tb_q1reason;
        public string opt_q2;
        public string tb_q2reason;
        public string opt_q3;
        public string tb_q3reason;
        public string opt_q4;
        public string tb_q4reason;
        public string opt_q5;
        public string tb_q5reason;
        public string opt_q6;
        public string tb_q6reason;
        public string opt_q7;
        public string tb_q7reason;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                DateTime closes = new DateTime(2017, 11, 3, 16, 0, 0);
                if (DateTime.Now >= closes)
                {
                    Session["policysubmissions_closed"] = "Proposed Parking Management Plan and Parking Bylaw";
                    Session["policysubmissions_datetime"] = "4:00pm Friday 3 November 2017";
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            string submissionpath = WebConfigurationManager.AppSettings["PolicySubmissions" + ".submissionpath"] + "parking1117\\";
            string submissionurl = WebConfigurationManager.AppSettings["PolicySubmissions" + ".submissionurl"] + "parking1117/";
            ...
            string emailSubject = WebConfigurationManager.AppSettings["PolicySubmissions.emailSubject"] + " - Parking";
            ...
            tb_q1reason = Request.Form["tb_q1reason"].Trim();
            opt_q2 = Request.Form["opt_q2"] + "";
            tb_q2reason = Request.Form["tb_q2reason"].Trim();
            opt_q3 = Request.Form["opt_q3"] + "";
            tb_q3reason = Request.Form["tb_q3reason"].Trim();
            opt_q4 = Request.Form["opt_q4"] + "";
            tb_q4reason = Request.Form["tb_q4reason"].Trim();
            opt_q5 = Request.Form["opt_q5"] + "";
            tb_q5reason = Request.Form["tb_q5reason"].Trim();
            opt_q6 = Request.Form["opt_q6"] + "";
            tb_q6reason = Request.Form["tb_q6reason"].Trim();
            opt_q7 = Request.Form["opt_q7"] + "";
            tb_q7reason = Request.Form["tb_q7reason"].Trim();
            ...
            #region setup specific data
            cmd.CommandText = "PS_Update_parking1117";
            ...
            cmd.Parameters.Add("@q1reason", SqlDbType.VarChar).Value = tb_q1reason;
            cmd.Parameters.Add("@q2", SqlDbType.VarChar).Value = opt_q2;
            cmd.Parameters.Add("@q2reason", SqlDbType.VarChar).Value = tb_q2reason;
            cmd.Parameters.Add("@q3", SqlDbType.VarChar).Value = opt_q3;
            cmd.Parameters.Add("@q3reason", SqlDbType.VarChar).Value = tb_q3reason;
            cmd.Parameters.Add("@q4", SqlDbType.VarChar).Value = opt_q4;
            cmd.Parameters.Add("@q4reason", SqlDbType.VarChar).Value = tb_q4reason;
            cmd.Parameters.Add("@q5", SqlDbType.VarChar).Value = opt_q5;
            cmd.Parameters.Add("@q5reason", SqlDbType.VarChar).Value = tb_q5reason;
            cmd.Parameters.Add("@q6", SqlDbType.VarChar).Value = opt_q6;
            cmd.Parameters.Add("@q6reason", SqlDbType.VarChar).Value = tb_q6reason;
            cmd.Parameters.Add("@q7", SqlDbType.VarChar).Value = opt_q7;
            cmd.Parameters.Add("@q7reason", SqlDbType.VarChar).Value = tb_q7reason;
            ...
            Response.Redirect("../completed.aspx?module=" + "PolicySubmissions" + "&id=" + "parking1117" + "\\" + reference);
        }
    }
}
