<%@ Page Title="Submission:  Proposed Significance and Engagement Policy" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online.PolicySubmissions.SignificanceandEngagement1117._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Submission: Proposed Significance and Engagement Policy
    </h1>
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <p>Written submissions may be made by downloading the <a href="http://www.whanganui.govt.nz/our-district/have-your-say/significance-and-engagement/Documents/Proposed Significance and Engagement Policy 2017.pdf">form</a>, completing it and posting or delivering it to:  </p>
            <p>
                <b>Proposed Significance and Engagement Policy</b>
                <br />
    ...
    <div class="table-responsive">
        <table class="table-striped table-bordered" style="width: 100%;">
            ...
            <tr>
                <td>
                    <br />
                    Do you agree for Council to use the criteria set out in the proposed policy (<a href="http://www.whanganui.govt.nz/our-district/have-your-say/significance-and-engagement/Documents/Proposed%20Significance%20and%20Engagement%20Policy%202017.pdf#page=9" onclick="location.reload()" target="pdf">pg. 9-10</a>) when determining the significance of an issue, matter or proposal?</td>
                <td class="tdcenter">
            ...
            <tr>
                <td>
                    Can you suggest any other criteria Council should use in determining the significance of an issue, matter or proposal?</td>
                 <td colspan="5" style="width: 50%">
                    <textarea id="tb_q1othercriteria" name="tb_q1othercriteria" class="form-control" rows="4" cols="20"></textarea></td>
            </tr>
     

            <tr>
                <td>
                    Do you generally agree with the contents and engagement methods listed in the engagement toolbox (<a href="http://www.whanganui.govt.nz/our-district/have-your-say/significance-and-engagement/Documents/Proposed%20Significance%20and%20Engagement%20Policy%202017.pdf#page=19" onclick="location.reload()" target="pdf">pg. 19-33</a>)?</td>
                 <td class="tdcenter">
            ...
            <tr>
                <td>
                    Are there any other types of engagement you would like to see Council use when informing or engaging with communities?</td>
                <td colspan="5" style="width: 50%">
                    <textarea id="tb_q2othertypes" name="tb_q2othertypes" class="form-control" rows="4" cols="20"></textarea></td>
            </tr>
     

            <tr>
                <td>
                    Overall, do you generally agree with the contents of the proposed policy?</td>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
        <label class="control-label col-sm-4" for="fu_documents">Please upload any other documents that you would like to submit.
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            ...
            <p>
                ...
                Note: Submissions will be heard on <b>Tuesday 12 February 2018</b>. If you have indicated that you wish to speak on your submission we will contact you to arrange a time.
            </p>
        </div>
    </div>
