<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Online.PolicySubmissions.RepresentationReview1018.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#dd_submissionmade').change(function () {
                if ($(this).val() == 'Yes') {
                    $('#div_main').show();
                    $('#div_unavailable').hide();
                } else {
                    $('#div_main').hide();
                    $('#div_unavailable').show();
                }
            })
        ...
        if (Online.WDCFunctions.WDCFunctions.onlinemode() == "online" && administration == "")
        {
        %>,
            ...
            $("[name='rb_location']").change(function () {
                if ($(this).attr("id") == 'rb_location_13') {
                    $("#span_otherlocation").show();
                } else {
                    $("#span_otherlocation").hide();
                    $("#tb_otherlocation").val("");
                }
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="dd_submissionmade">
            Did you make a submission on the initial proposal (between 20 June and 3 August 2018)?
        </label>
        <div class="col-sm-8">
            <select id="dd_submissionmade" name="dd_submissionmade" class="form-control" required>
                <option></option>
                <option>Yes</option>
                <option>No</option>
            </select>
    ...
    <div id="div_unavailable" style="display: none" class="panel panel-danger">
        <div class="panel-heading">Note</div>
        <div class="panel-body">
            <p>Sorry, but the appeals process is only open to those who made a submission on the initial proposal (between 20 June and 3 August 2018)</p>
        </div>
    </div>
    ...
    <div id="div_main" style="display: none">
        ...
        <div class="form-group">
            <label class="control-label col-sm-4" for="tb_submission">
                Please explain what you wish to appeal  
                <img src="../../Images/questionsmall.png" alt="Help" title="Your appeal must relate to your original submission" />
            </label>
            <div class="col-sm-8">
                <textarea id="tb_submission" name="tb_submission" class="form-control" rows="4" required></textarea>
            </div>
        </div>
        ...
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <p>
                    Your appeal will be forwarded to the Local Government Commission to make a final determination on the representation arrangements for the district. If you would like to be heard by the Local Government Commission in relation to your appeal please tick the box below. 
                </p>
                <p>
                    <input type="checkbox" id="cb_speak" name="cb_speak" value="Yes" />
                    Yes, I would like to speak in support of my appeal (please ensure you have completed the details above, including your contact phone number).<br />
                    ...
                    <b>Note</b>: A hearing may be held to hear appeals on a date to be advised. If you have indicated that you wish to speak to your appeal you will be contacted to arrange a time. 
        ...
        <div id="div_optional" style="display: none">
            <div class="panel panel-danger">
            ...
            <div class="form-group">
                <label class="control-label col-sm-4" for="cb_ethnicity">Location</label>
                <div class="col-sm-8">

                    <asp:Literal ID="lit_locations" runat="server"></asp:Literal>

                    <span id="span_otherlocation" style="display: none">please state:
                <input type="text" id="tb_otherlocation" name="tb_otherlocation" class="form-control" /></span>
