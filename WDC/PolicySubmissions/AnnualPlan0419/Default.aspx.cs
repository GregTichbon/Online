...
namespace Online.PolicySubmissions.AnnualPlan0419
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    Page.Title = "Submission: Proposed 2019/20 Annual Plan";
                    title = "Submission: Proposed 2019/20 Annual Plan";
                    shorttitle = "Proposed 2019/20 Annual Plan";
                    closes = new DateTime(2019, 04, 24, 16, 0, 0);
                    ...
                    submissionshearing = "Wednesday, 8 May and Thursday, 9 May 2019";
                    bylawpolicy = "bylaw";
                    SP = "PS_Update_AnnualPlan0419";
                    shortname = "AnnualPlan0419";
                    specificemailsubject = "Submission: Proposed 2019/20 Annual Plan";
                    overrideBCC = "Annualplan2019@whanganui.govt.nz";
            ...
            foreach (DataRow row in parameterstable.Rows)
            {
                ...
                switch (type)
                {
                    ...
                    case "Option":
                        ...
                        htmlbuilder += "</tr>";
                        break;
                    case "TextinTableBelow":
                        htmlbuilder += "<tr><td colspan=\"6\">" + detail + "<br /><textarea id=\"tb_" + dbid + "\" name=\"tb_" + dbid + "\" class=\"form-control\" rows=\"4\"></textarea></td></tr>";
                        break;
                        // case "TextBelow":
                        //     htmlbuilder += detail + "<br /><textarea id=\"tb_" + dbid + "\" name=\"tb_" + dbid + "\" class=\"form-control\" rows=\"4\"></textarea>";
                        //     break;
                }
            }
            ...
            html += "<tr>";
            html += "<td><b>KEY CHANGES</b><br />Please indicate your level of agreement for the key change, outlined in the 2019/20 Annual Plan Consultation Document.  You can submit on any aspect of the Consultation Document or Supporting Information. The table below outlines the key change from the Long Term Plan 2018-2028. </td>";
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (overrideBCC != "")
            {
                emailBCC = overrideBCC;
            }
            else
            {
                emailBCC = WebConfigurationManager.AppSettings["PolicySubmissions.emailBCC"];
            }
            ...
            parametersview = new DataView(parameterstable, "type in ('option','TextinTableBelow')", "sequence", DataViewRowState.CurrentRows);
            foreach (DataRowView rowView in parametersview)
            {
                ...
                switch (type)
                {
                    ...
                    // break;
                    case "Option":
                        val = Request.Form["opt_" + dbid] + "";
                        break;
                    case "TextinTableBelow":
                        val = Request.Form["tb_" + dbid] + ""; break;
                        // case "TextBelow":
                        //     htmlbuilder += detail + "<br /><textarea id=\"tb_" + dbid + "\" name=\"tb_" + dbid + "\" class=\"form-control\" rows=\"4\"></textarea>";
                        //     break;
                }
