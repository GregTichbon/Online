...
namespace Online.PolicySubmissions.Signage1018
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        {
            Page.Title = "Submission: Proposed Signage Policy 2018";
            title = "Submission: Proposed Signage Policy 2018";
            shorttitle = "Proposed Signage Policy 2018";
            ...
            bylawpolicy = "bylaw";
            SP = "PS_Update_Signage1018";
            shortname = "Signage1018";
            specificemailsubject = "Submission: Proposed Signage Policy 2018";
            ...
            documentvalues["q1"] = "<b>ELECTION SIGNS<br />The rules for signs for candidates in local government election should be the same as general elections.</b><br/><br />If supported, this would mean a local election signage would be at a maximise size of 3 square metres, permitted to be displayed during election periods only and not create a traffic hazard (pg 3 of SOP). ";
            documentvalues["q2"] = "<b>CONTENT OF SIGNS<br />The content of signs should be managed through national legislation.</b><br /><br />If supported, this would mean that Council would rely on the Films, Video and Publications Classification Act 1993 and the Human Rights Act 1993 to manage objectionable content on signs (pg 4 & 5 of SOP). ";
            documentvalues["q3"] = "<b>FOOTPATH SIGNS<br />The maximum height of footpath signs <u>within 6 metres of an intersection or pedestrian crossing</u> should be restricted to a maximum of 1 metre in height for traffic safety concerns</b>(pg 6 & 7 of SOP).<br/><br />If supported, this would mean that within 18 months signs <u>within 6 metres of an intersection or pedestrian crossing</u> would need be no higher than 1 metre in height.  ";
            documentvalues["q4"] = "<b>The maximum height of <u>all</u> footpath signs should be restricted to a maximum of 1 metre in height for traffic safety concerns</b> (pg 6 & 7 of SOP).<br /><br />If supported, this would mean that within 18 months <u>all</u> footpath signs would need be no higher than 1 metre in height unless it had approval from Council.";
    ...
    */
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            cmd.Parameters.Add("@reason4", SqlDbType.VarChar).Value = reason_q4;
