...
namespace Online.PolicySubmissions.SaferWhanganui0818
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            Page.Title = "Submission: Draft Safer Whanganui Strategic Plan";
            title = "Submission: Draft Safer Whanganui Strategic Plan";
            shorttitle = "Draft Safer Whanganui Strategic Plan";
            closes = new DateTime(2018, 8, 10, 16, 0, 0);
            ...
            submissionshearing = "Wednesday 22 August 2018";
            bylawpolicy = "bylaw";
            SP = "PS_Update_SaferWhanganui0818";
            shortname = "SaferWhanganui0818";
            specificemailsubject = "Submission: Draft Safer Whanganui Strategic Plan";
            ...
            documentvalues["q1"] = "Do you generally agree with the draft strategic plan’s vision? <i>Safer Whanganui- Works for everyone, a positive place to live, learn, work and play?</i> (pg. 3)";
            documentvalues["q2"] = "Do you agree with the goal <i>Youth - We are a community that is the best place to start your life</i> and how this goal will be achieved? (pg. 15)";
            documentvalues["q3"] = "Do you agree with the goal <i>Places - Our built environments are safe</i> and how this goal will be achieved?(pg. 16)";
            documentvalues["q4"] = "Do you agree with the goal <i>Community – We are connected and collaborative community</i> and how this goal will be achieved? (pp. 17-18)";
            documentvalues["q5"] = "Do you agree with the goal <i>Homes - Every Whanganui resident has a safe home to live in</i> and how this goal will be achieved? (pg. 19)";
            documentvalues["q6"] = "Do you generally agree with the proposed actions Safer Whanganui will undertake with collaborators? (pp. 15-19)";
            documentvalues["q7"] = "Overall, do you generally agree with the contents of the draft strategic plan?";
            ...
            int num_options = 7;
            for (int f1 = 1; f1 <= num_options; f1++)
            {
                lit_questions1.Text += "<tr>";
            ...
            lit_questions1.Text += "<br />";

            lit_questions1.Text += "<div class=\"form-group\">";
            lit_questions1.Text += "<label class=\"control-label col-sm-4\" for=\"tb_missingactions\">Do you think we are missing any actions to address community safety? If so please list:</label>";
            lit_questions1.Text += "<div class=\"col-sm-8\">";
            lit_questions1.Text += "<textarea id=\"tb_missingactions\" name=\"tb_missingactions\" class=\"form-control\" rows=\"4\"></textarea>";
            lit_questions1.Text += "</div>";
            lit_questions1.Text += "</div>";
        ...
        {
            if (Page.IsPostBack && (Request.Form["g-recaptcha-response"] == null || Request.Form["g-recaptcha-response"] == ""))
            {
                Session["message_title"] = "Invalid Form Submission";
                Session["message_head"] = "Re-captcha failed";
                Session["message_message"] = "For some reason we could not validate that you were Not a robot.  Please try again.";
                Session["message_redirect"] = Request.Url.ToString();
            ...
            */
            ...
            missingactions = Request.Form["tb_missingactions"].Trim();
            ...
            //cmd.Parameters.Add("@location", SqlDbType.VarChar).Value = location;
            cmd.Parameters.Add("@missingactions", SqlDbType.VarChar).Value = missingactions;
