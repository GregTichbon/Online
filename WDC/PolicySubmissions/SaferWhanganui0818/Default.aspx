<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Online.PolicySubmissions.SaferWhanganui0818.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_furthercomments">Please use this space to provide reasons for your responses to the above. In particular, if you disagreed with any of the proposals please let us know why and provide any alternative options you may have:</label>
        <div class="col-sm-8">
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            ...
            <p>
                ...
                <b>Note</b>: Submissions will be heard on <b><%: submissionshearing %></b>. If you have indicated that you wish to speak on your submission we will contact you to arrange a time.
