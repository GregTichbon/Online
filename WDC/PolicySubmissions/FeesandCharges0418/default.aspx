<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online.PolicySubmissions.FeesandCharges0418._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_comments">Comments about the proposed Fees and Charges for 2018/19:</label>
        <div class="col-sm-8">
