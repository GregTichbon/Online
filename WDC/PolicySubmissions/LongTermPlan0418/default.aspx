<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online.PolicySubmissions.LongTermPlan0418._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="div_organisation" style="display: none">
        ...
        <br />
                    <asp:Literal ID="Lit_quest_WhoPays" runat="server"></asp:Literal>
       <br />
                    <asp:Literal ID="lit_questions2" runat="server"></asp:Literal>
    ...
    <%     
        if (HttpContext.Current.Request.Url.AbsolutePath.ToLower().Substring(0, 8) == "/online/" && administration == "" || 1 == 1)
        {
    %>
