...
{
    public partial class EasterSunday1017 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["administration"] == "0n11n3")
            {
                ...
                DateTime closes = new DateTime(2017, 10, 27, 16, 0, 0);
                if (DateTime.Now >= closes)
                {
                    Session["policysubmissions_closed"] = "Proposed Local Easter Sunday Trading Policy";
                    Session["policysubmissions_datetime"] = "4:00pm Friday 27 October 2017";
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            string submissionpath = WebConfigurationManager.AppSettings["PolicySubmissions" + ".submissionpath"] + "EasterSunday1017\\";
            string submissionurl = WebConfigurationManager.AppSettings["PolicySubmissions" + ".submissionurl"] + "EasterSunday1017/";
            ...
            string emailSubject = WebConfigurationManager.AppSettings["PolicySubmissions.emailSubject"] + " - Easter Sunday Trading";
            ...
            #region setup specific data
            cmd.CommandText = "PS_Update_EasterSunday1017";
            ...
            Response.Redirect("../completed.aspx?module=" + "PolicySubmissions" + "&id=" + "EasterSunday1017" + "\\" + reference);
        }
    }
}
