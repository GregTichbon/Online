<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online.PolicySubmissions.TradeWastes0218._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <p>Written submissions may be made by downloading the <a href="<%: form%>">form</a>, completing it and posting or delivering it to:  </p>
            <p>
                <b><%: shorttitle %></b>
                <br />
...
<tr>
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_furthercomments">Please use this space to provide reasons as to your selections above, to comment on any other aspects of the proposed <%: bylawpolicy %> and to add any further comments.</label>
        <div class="col-sm-8">
