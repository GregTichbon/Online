<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online.PolicySubmissions.PukenamuQueensPark0518._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="table-responsive">
        <table class="table-striped table-bordered" style="width: 100%;">
            <tr>
                <td colspan="2"><b>Change of Reserve Purpose</b><br />
                    Council is proposing to change the Reserves Act classification of Pukenamu/Queens Park from ‘local purpose (site of municipal buildings)’ to ‘local purpose (culture and heritage).’  The change will more closely reflect the use of the Reserve and recognises the cultural and heritage significance of the site.  
                </td>
            </tr>
            ...
            <tr><td>
            <div class="form-group">
                <label class="control-label col-sm-4" for="dd_changeofpurpose">Do you agree with the Change of Purpose?</label>
                <div class="col-sm-8">
                    <select id="dd_changeofpurpose" name="dd_changeofpurpose" class="form-control" >
                <option></option>
                <option>Yes</option>
                <option>No</option>
            </select>
            ...
            <div class="form-group" id="div_changeofpurpose" style="display:none">
                <label class="control-label col-sm-4" for="tb_changeofpurpose">Please state your reason(s):</label>
                <div class="col-sm-8">
                    <textarea id="tb_changeofpurpose" name="tb_changeofpurpose" class="form-control" rows="4" required></textarea>
                </div>
            </div>
                </td></tr>
        </table>
    ...
    <br />
       ...
       <div class="table-responsive">
        <table class="table-striped table-bordered" style="width: 100%;">
            <tr>
                <td colspan="2"><b>Inclusion of Maori Name in Park Title</b><br />
                    Council is seeking feedback on the inclusion of the Maori name, Pukenamu, in the Park’s title.  Including the Maori name is seen as a way to acknowledge the cultural history of the site.  “Pukenamu” means sand hill and was the name originally given to the Park by local Maori.  
                </td>
            </tr>
            ...
            <tr><td>
            <div class="form-group">
                <label class="control-label col-sm-4" for="dd_maoriname">Do you agree with including the Maori name in the Park’s title?</label>
                <div class="col-sm-8">
                    <select id="dd_maoriname" name="dd_maoriname" class="form-control" >
                <option></option>
                <option>Yes</option>
                <option>No</option>
            </select>
            ...
            <div class="form-group">
                <label class="control-label col-sm-4" for="tb_maoriname">Comments:</label>
                <div class="col-sm-8">
                    <textarea id="tb_maoriname" name="tb_maoriname" class="form-control" rows="4"></textarea>
                </div>
            </div>
                </td></tr>
        </table>
