<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="Online.PolicySubmissions.Castlecliff0818.Test" %>
        ...
        { %>
            $("#form1").validate({
                ...
                submitHandler: function (form) {
                    alert('submitHandler: ' + grecaptcha.getResponse());
