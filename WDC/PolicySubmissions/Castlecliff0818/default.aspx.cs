...
namespace Online.PolicySubmissions.Castlecliff0818
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        {
            Page.Title = "Submission: PCastlecliff Coastal Reserve Management Plan";
            title = "Submission: Castlecliff Coastal Reserve Management Plan";
            shorttitle = "Castlecliff Coastal Reserve Management Plan";
            closes = new DateTime(2018, 8, 17, 16, 0, 0);
            ...
            bylawpolicy = "bylaw";
            SP = "PS_Update_Castlecliff0818";
            shortname = "Castlecliff0818";
            specificemailsubject = "Submission: Castlecliff Coastal Reserve Management Plan";
            ...
            documentvalues["q1"] = "Recognise and protect the special relationship that Ngaa Rauru Kiitahi and Tupoho, as Tangata Whenua, have with this Reserve as a site of cultural and spiritual significance, and as a reference point for whanau, hapu and iwi identity.";
            documentvalues["q2"] = "To continue to support an ongoing collaborative relationship with the Castlecliff community, in relation to the development and implementation of this reserve management plan.";
            documentvalues["q3"] = "Minimise adverse effects on the natural environment and potential conflicts between reserve users.";
            documentvalues["q4"] = "Ensure that reserve facilities are maintained and upgraded where necessary, to enable the community to continue to use and enjoy such facilities.";
            documentvalues["q5"] = "Clear signage is established and maintained throughout the Reserve that which assists in user orientation wayfinding and enhances educational opportunities informs people about in the natural, cultural and historical stories of the Reserve.";
            documentvalues["q6"] = "To stabilise and reinstate the dynamic dune system, whist providing for compatible recreational activities within the reserve.";
            documentvalues["q7"] = "Protect and where practical, enhance the natural environment and interface between the beach front, sand dunes, reserve area and urban development.";
            documentvalues["q8"] = "To allow for the occupation of the reserves for approved uses and facilities by the granting of a lease, licence or permit.";
