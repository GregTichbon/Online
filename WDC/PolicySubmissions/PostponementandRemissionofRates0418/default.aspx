<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online.PolicySubmissions.PostponementandRemissionofRates0418._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_comments">Comments about the proposed Postponement of Rates or Remission of Rates Policies:</label>
        <div class="col-sm-8">
            <textarea id="tb_comments" name="tb_comments" class="form-control" rows="4"></textarea>
        </div>  
    </div>
