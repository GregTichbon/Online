<%@ Page Title="Submission:  Proposed Development Contributions Policy" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Online.PolicySubmissions.DevelopmentContributions0218._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Submission: Proposed Development Contributions Policy 2018
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <p>Written submissions may be made by downloading the <a href="http://www.whanganui.govt.nz/our-district/have-your-say/development-contributions-policy/Documents/Proposed Development Contributions Policy submission form FINAL.pdf">form</a>, completing it and posting or delivering it to:  </p>
            <p>
                <b>Proposed Development Contributions Policy 2018</b>
                <br />
    ...
    <p>Please indicate your level of agreement for the following key issues.</p>
    <div class="table-responsive">
        <table class="table-striped table-bordered" style="width: 100%;">
            ...
            <tr>
                <td>
                    <br />
                    <asp:Literal ID="lit_q1" runat="server"></asp:Literal></td>
                <td class="tdcenter">
...
<tr>
                <td>
                    <br />
                    <asp:Literal ID="lit_q2" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
                ...
                <td>
                    <br />
                    <asp:Literal ID="lit_q3" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
                ...
                <td>
                    <br />
                    <asp:Literal ID="lit_q4" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
                ...
                <td>
                    <br />
                    <asp:Literal ID="lit_q5" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
                ...
                <td>
                    <br />
                    <asp:Literal ID="lit_q6" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
                ...
                <td>
                    <br />
                    <asp:Literal ID="lit_q7" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
                ...
                <td>
                    <br />
                    <asp:Literal ID="lit_q8" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
                ...
                <td>
                    <br />
                    <asp:Literal ID="lit_q9" runat="server"></asp:Literal> </td>
                <td class="tdcenter">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_furthercomments">Please use this space to provide reasons as to your selections above, to comment on any other aspects of the proposed policy, and to add any further comments.</label>
        <div class="col-sm-8">
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            ...
            <p>
                ...
                Note: Submissions will be heard on <b>Monday 12 February 2018</b>. If you have indicated that you wish to speak on your submission we will contact you to arrange a time.
            </p>
        </div>
    </div>
