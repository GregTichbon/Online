...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_event">What was your event?</label>
        <div class="col-sm-8">
    ...
    <div class="form-group" style="background-color: #f7e6e6">
        <label class="control-label col-sm-4" for="dd_bookingease">How easy was it to book at the War Memorial Centre</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="dd_communications">How was the communication from the War Memorial Centre leading up to your event</label>
        <div class="col-sm-8">
            <select id="dd_communications" name="dd_communications" class="form-control" required>
                <option></option>
                <option>Poor</option>
        ...
        <label class="control-label col-sm-4" for="tb_communications">Comments</label>
        <div class="col-sm-8">
            <textarea id="tb_communications" name="tb_communications" class="form-control" rows="3"></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="tb_name">Your Name (optional)</label>
        <div class="col-sm-8">
    ...
    <div class="form-group" style="background-color: #f7e6e6">
        <label class="control-label col-sm-4" for="tb_contactdetails">Contact details (if you would like us to contact you)</label>
        <div class="col-sm-8">
            <textarea id="tb_contactdetails" name="tb_contactdetails" class="form-control" rows="3"></textarea>
        </div>
    </div>
