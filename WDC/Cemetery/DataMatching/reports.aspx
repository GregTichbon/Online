    ...
    <script>
        $(document).ready(function () {
            ...
            $("#href_report4").click(function () {
                ...
                $.getJSON('../data.asmx/ArchivistDataMatchingReports?mode=area', function (data) {
                    $.each(data, function (i, item) {
                        var $tr = $('<tr class="plotdata">').append(
                            $('<td>').text(item.cemetery),
                            $('<td>').text(item.area),
             ...
             $("#href_report5").click(function () {
                ...
                $.getJSON('../data.asmx/ArchivistDataMatchingReports?mode=block', function (data) {
                    $.each(data, function (i, item) {
                        var $tr = $('<tr class="plotdata">').append(
                            $('<td>').text(item.cemetery),
                            $('<td>').text(item.area),
            ...
            $("#href_report6").click(function () {
                ...
                $.getJSON('../data.asmx/ArchivistDataMatchingReports?mode=division', function (data) {
                    $.each(data, function (i, item) {
                        var $tr = $('<tr class="plotdata">').append(
                            $('<td>').text(item.cemetery),
                            $('<td>').text(item.area),
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3>Archivsts Data</h3>
    <p><a href="javascript:void(0)" id="href_report4">Areas that are not in the standardised data</a></p>

    <p><a href="javascript:void(0)" id="href_report5">Blocks that are not in the standardised data</a></p>

    <p><a href="javascript:void(0)" id="href_report6">Divisions that are not in the standardised data</a></p>
