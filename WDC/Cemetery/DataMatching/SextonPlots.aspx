    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btn_search").click(function () {
                //plotid is made up of clientID / PlotID
                $('table tr.plotdata').remove();
            ...
            $("#btn_update").click(function () {
                ...
                $("#dialog-text").html("Please confirm that you want to update the <b>" + $(".sel_plot:checked").length + "</b> selected plots from:<br />" + existingplot + "<br />to<br />" + newplot);
            ...
            $("#dialog-confirm").dialog({
                ...
                buttons: {
                    "Update all items": function () {
                        ...
                        $('<input>').attr({
                            type: 'hidden',
                            name: 'hf_newdivisionid',
                            value: $('#std_division').val()
                        }).appendTo('form');
                        */

                        $('.btn_submit').click();

                        //alert('To do: Update Table:Plots, Column:DivisionID to ' + $('#std_division').val() + ' for plotid: ' + ids);
            ...
            $('body').on('click', '.view', function () {
                ...
                $(".view").colorbox({ href: "../view.aspx?id=S" + id, iframe: true, height: "800", width: "700", overlayClose: true });
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <input type="button" id="btn_search" value="Search" />
    ...
    <div id="standardised">
        ...
        <asp:Button ID="btn_submit" class="btn_submit" runat="server" Text="Submit" OnClick="btn_submit_Click" />
    </div>
    <p></p>
