<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Online.Cemetery.Search" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <% if (1 == 2)
        { %>
    <link href="../Scripts/RateYo/jquery.rateyo.min.css" rel="stylesheet" />
    <script src="../Scripts/RateYo/jquery.rateyo.min.js"></script>
    <%}%>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.view', function () {
                id = $(this).attr("id");
                $(".view").colorbox({ href: "view.aspx?id=" + id + "<%=mode%>", iframe: true, height: "800", width: "700", overlayClose: true });
            });
    <% if (1 == 2)
        { %>
            $("#rateYo").rateYo({
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h4>The Cemetery Search tool contains burial information for the Aramoho Cemetery. To access information about your relatives in other Whanganui District Council-controlled cemeteries or for more details of cremation records contact:  </h4>
    <p><strong>The Alexander Heritage &amp; Research Library</strong><br />Phone: (06) 349 1000<br />Email: <a href="mailto:info@whanganuilibrary.com">info@whanganuilibrary.com</a>  </p>
    <p><strong>The Aramoho Cemetery sexton:</strong><br />Phone: (06) 343 9412<br />Email: <a href="mailto:gary.gleeson@whanganui.govt.nz">gary.gleeson@whanganui.govt.nz</a> </p>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form>
        <div class="form-group">
            <label class="control-label col-sm-4" for="xxxxxx">Rate</label>
            <div class="col-sm-8">
                <span id="rateYo"></span>
                <input id="btn_rate" type="button" value="Rate" class="btn btn-info submit" />
            </div>
        </div>
    </form>
    <%}%>
