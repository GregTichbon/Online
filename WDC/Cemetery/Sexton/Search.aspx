<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Online.Cemetery.Sexton.Search" %>
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.view', function () {
                ...
                if (id.substring(0, 1) == 'S') {
                    $(".view").colorbox({ href: "personentry.aspx?id=" + id, iframe: true, height: "800", width: "700", overlayClose: true });
                } else {
                    $(".view").colorbox({ href: "../archive/entry.aspx?id=" + id, iframe: true, height: "800", width: "700", overlayClose: true });
                }
            });
