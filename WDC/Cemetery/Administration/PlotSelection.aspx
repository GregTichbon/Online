<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlotSelection.aspx.cs" Inherits="Online.Cemetery.Administration.PlotSelection" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btn_select').click(function () {
                key = $('#hf_key').val();
                label = $('#dd_cemetery option:selected').text() + " " + $('#dd_area option:selected').text() + " " + $('#dd_plot option:selected').text();
