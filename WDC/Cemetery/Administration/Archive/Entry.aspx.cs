...
namespace Online.Cemetery.Administration.Archive
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    burydate = WDCFunctions.WDCFunctions.formatdate(dr["burydate"].ToString(), "dd MMM yyyy");
                    dob = WDCFunctions.WDCFunctions.formatdate(dr["dob"].ToString(), "dd MMM yyyy");
                    dod = WDCFunctions.WDCFunctions.formatdate(dr["dod"].ToString(), "dd MMM yyyy");
                    ...
                    burialdate = Convert.ToDateTime(dr["burialdate"]).ToString("dd MMM yyyy");
