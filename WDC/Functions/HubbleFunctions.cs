...
namespace Online.WDCFunctions
{
    ...
    public class HubbleFunctions
    {
        ...
        private static NetworkCredential credentials()
        {
            ...
            foreach (char c in "0nl1n3$3Rvice".ToCharArray()) passWord.AppendChar(c);
        ...
        **************************************************************************************/
        ...
        public void UploadFile(string siteURL, string listName, string listURL, string itemName, byte[] itembytes, Dictionary<string, string> metaAllFields)
        {
            Online.WDCFunctions.WDCFunctions WDCFunctions = new Online.WDCFunctions.WDCFunctions();
            ...
            using (ClientContext clientContext = new ClientContext(siteURL))
            {
                ...
                foreach (KeyValuePair<string, string> metaPair in metaAllFields)
                {
                    uploadFile.ListItemAllFields[metaPair.Key] = metaPair.Value;
                }
