<%@ Page Title="" Language="C#" MasterPageFile="~/UBC.Master" AutoEventWireup="true" CodeBehind="BookingList.aspx.cs" Inherits="UBC.People.BookingList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="background-color: #FCF7EA">
        ...
        <h1>Union Boat Club - Bookings
        </h1>

        <h2><a href="booking.aspx?id=new" target="edit">New</a></h2>
        <div class="form-inline">
        Show bookings from: <!--between: -->
