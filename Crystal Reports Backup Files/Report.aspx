<%@ Page Title="" Language="C#" MasterPageFile="~/UBC.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="UBC.People.Reports.Report" %>
    ...
    <script>
        $(document).ready(function () {
             ...
             $('#export').click(function () {
                var table = "<table>";
				$('#attendance > thead > tr').each(function () {
					table += "<tr>";
