<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entry2.aspx.cs" Inherits="DataInnovations.Row.Entry2" %>
        ...
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width: 10%; text-align: right">Prognostic</th>
                    <th style="width: 50%">Competitor(s)</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="search" id="category" name="category" class="form-control" /></td>
                    <td id="prognostic" style="text-align: right"></td>
