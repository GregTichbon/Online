<%@ Page Title="" Language="C#" MasterPageFile="~/UBC.Master" AutoEventWireup="true" CodeBehind="KeyRegister.aspx.cs" Inherits="UBC.People.KeyRegister" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("input").change(function () {
                var arForm = { table: 'person', field: "keynumber", id: $(this).attr("id").substring(4), value: $(this).val(), keyfield: 'guid' };
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="background-color: #FCF7EA">
        ...
        <h1>Union Boat Club - Key register
        </h1>
