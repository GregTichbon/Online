...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="background-color:#B1C9E6" >
        ...
        <div class="form-group">
            <label class="control-label col-sm-4" for="tb_usercode">Are you an existing member?</label>
            <div class="col-sm-8">
        ...
        <div id="div_exising" style="display: none">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    You should have received this by text or email at the start of the new season.  If you can't find it please email <a href="mailto:info@unionboatclub.co.nz">info@unionboatclub.co.nz</a> to request one.
                </div>
