            ...
            $('#rbl_invoicetype').change(function () {
                ...
                switch (selectedvalue) {
                    case 'Application':
                        ...
                        $('#tb_reference1').val('20151008782') //Testing
                        $('#tb_reference2').val('BL2015/238')  //Testing
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="paymentform" class="table table-hover table-responsive" style="display: <%: none%>">
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="btn_payinvoice" runat="server" Text="Pay this Invoice" OnClick="btn_payinvoice_Click" class="btn btn-info" />
            </td>
        </tr>
