<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoginAssistance.aspx.cs" Inherits="Online.Entity.LoginAssistance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        else
        {
            ...
            $('#a_register').attr('href', 'entity.aspx<%=url %>');
